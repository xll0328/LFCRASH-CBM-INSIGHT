...
| Reviewer map and operating-point figure still lacked tiered visual hierarchy | Added macaron tier-card backgrounds in reviewer evidence map and applied panel/legend micro-polish to safety-utility figure while preserving evidence tiers and wording | `paper/emnlp2026/sec_experiments_emnlp.tex`, `paper/emnlp2026/insight_emnlp.tex`, `paper/neurips2026/insight_viz.py`, `paper/figures/insight_fig5_safety_utility.{png,pdf}` | Done |
| Intervention gallery case text was too small in the compiled PDF | Increased per-case typography density, shortened verbose labels, regenerated `dual_interp_case{1,2,3}`, and switched gallery layout from one-row-3col to `2+1` for readability | `paper/neurips2026/viz_insight.py`, `paper/figures/dual_interp_case{1,2,3}.png`, `paper/emnlp2026/sec_experiments_emnlp.tex` | Done |
