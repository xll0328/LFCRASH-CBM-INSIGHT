...
% Soft macaron palette for reviewer-friendly table readability.
\definecolor{MacaronBlue}{HTML}{AFCBEA}
\definecolor{MacaronMint}{HTML}{BFE6D8}
\definecolor{MacaronPeach}{HTML}{F7CBB9}
\definecolor{MacaronLavender}{HTML}{DCCEF3}
\definecolor{MacaronHeader}{HTML}{EAF3FC}
\definecolor{MacaronStripe}{HTML}{FAF6EF}
\definecolor{MacaronRule}{HTML}{C8D6E5}
\definecolor{MacaronText}{HTML}{2F4158}
\definecolor{MacaronCardBlue}{HTML}{EEF5FD}
\definecolor{MacaronCardMint}{HTML}{ECF8F3}
\definecolor{MacaronCardPeach}{HTML}{FDF1EA}

\newcommand{\TableStyleOn}{%
  \arrayrulecolor{MacaronRule}%
  \renewcommand{\arraystretch}{1.15}%
}
\newcommand{\TableStyleOff}{%
  \arrayrulecolor{black}%
  \renewcommand{\arraystretch}{1.0}%
}
\newcommand{\TableHead}{\rowcolor{MacaronHeader}}
...
\input{sec_intro_emnlp}
\input{sec_related_emnlp}
\input{sec_method_emnlp}
\input{sec_experiments_emnlp}
\input{sec_conclusion_emnlp}
