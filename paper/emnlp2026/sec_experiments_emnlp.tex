...
\begin{table}[t]
\caption{Protocol and evidence map for the main paper. Headline prediction,
...
\begin{table}[t]
  \centering
  \caption{Core execution scale behind the evidence tiers.}
...
\caption{Experiment portfolio map used for claim-tier reading. Panel A
...
\end{minipage}}
\caption{Visual evidence map for rapid claim-tier reading. The paper separates
...
\begin{table}[t]
\caption{Interpretability taxonomy for accident anticipation. The point of this
...
\caption{DAD mechanism-stress evidence across protocol blocks. We report three
...
\caption{Safety--utility view under semantic-interface constraints. Literature
...
\caption{Family coverage in the paper-facing ontology. The polished concept
...
\caption{Ontology evolution toward a paper-ready semantic interface. The
