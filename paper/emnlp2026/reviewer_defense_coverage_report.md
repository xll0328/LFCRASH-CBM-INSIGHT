...
- OK `EMNLP_ORAL_ACCEPT_CASE_ONEPAGER_20260427.md`
- OK `EMNLP_REVIEWER_QUICK_MAP.md`
- OK `EMNLP_REVIEW_RESPONSE_MAP.md`
- OK `EMNLP_REVIEW_RESPONSE_PLAYBOOK.md`
- OK `EMNLP_REVIEW_RESPONSE_TEMPLATES.md`
- OK `EMNLP_REVIEW_RESPONSE_TRACKER.md`

## Theme Coverage

- OK EMNLP venue fit: all required cues present
  - Venue-fit responses must make the language-grounded interface central.
- OK Ontology as modeling choice: all required cues present
  - Ontology responses must separate governed ontology choice from prompt tuning.
- OK DAD fragility boundary: all required cues present
  - DAD responses must preserve the stress-test framing and exact headline context.
- OK Actor-policy scope: all required cues present
  - Actor responses must keep policy timing scoped against classifier evidence.
- OK Intervention scope: all required cues present
  - Intervention responses must avoid turning structural evidence into broad causality.
- OK Human ontology audit scope: all required cues present
  - Human-audit responses must avoid claiming exhaustive validation.
- OK Single strongest reason to accept: all required cues present
