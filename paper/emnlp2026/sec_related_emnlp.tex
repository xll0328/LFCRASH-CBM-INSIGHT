...
Concurrent systems also explore efficiency-oriented and domain-enhanced variants
with interpretable side signals~\citep{song2025rare,guan2025domain,liu2025predictresist},
as well as world-model-based augmentation pipelines that target broader data
coverage~\citep{guan2025worldmodel}. These lines improve benchmark competitiveness,
but they still leave open the same core question we study here: can the
semantic interface itself be governed and compared as a first-class variable
under matched training protocols?
...
of that interface under matched training protocols and matched family-level controls.
