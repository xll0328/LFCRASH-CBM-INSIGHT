...
- OK Page 1 PDF extraction: ok
- OK Page 1 semantic-interface framing: ok
- OK Figure 1 caption defines the object: ok
- OK Protocol map prevents leaderboard pooling: ok
- OK Appendix opening provides scoped roadmap: ok
