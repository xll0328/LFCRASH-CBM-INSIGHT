...
To keep this auditable, we maintain a family-level hard-case symmetry audit
scaffold in the supplementary assets and treat any stronger symmetry statement
as bounded unless the paired outcomes are reviewer-confirmed and coverage is
broadened across hard scenario families. In the current snapshot, pair-level
confirmation is complete for the tracked mixed pairs, but breadth remains the
open risk.
