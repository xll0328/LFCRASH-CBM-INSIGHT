...
frequent degeneracy.
Eighth, DAD hard-case symmetry is still not established as a global property.
The current package now includes reviewer-confirmed mixed-pair audits, but
broad balanced success/failure coverage across hard scenario families remains
an open validation target.
