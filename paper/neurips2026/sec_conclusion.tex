...
frequent degeneracy.
Eighth, DAD hard-case symmetry is not yet established under the current package:
the synchronized diagnostics expose checkpoint variance, but they do not yet
show balanced success/failure behavior across hard scenario families.
