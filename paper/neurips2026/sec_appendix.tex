...
(\texttt{paper/neurips2026/dad\_hard\_case\_symmetry\_audit.md}) generated from archived
...
with reviewer-confirmed mixed pairs, not a claim that symmetry is solved.

\begin{table}[t]
\caption{DAD hard-case symmetry audit snapshot from archived v4 casebank assets.
Counts are from the current \texttt{strong\_top} pool under primary-family assignment.
\texttt{auto\_pair} denotes heuristic early-vs-late mixed pair slots (4 total), now
mapped to reviewer-confirmed outcomes in the synchronized audit file.}
...
\midrule
Intersection-merge & 1 & 3 & 10 & 4 \\
Night visibility & 0 & 0 & 6 & 0 \\
Pedestrian conflict & 0 & 0 & 7 & 0 \\
Road-surface weather & 0 & 0 & 2 & 0 \\
Heavy-vehicle conflict & 0 & 0 & 1 & 0 \\
\bottomrule
\end{tabular}
\end{table}
...
hard-case behavior, so stronger symmetry claims remain bounded even after
pair-level confirmation of the current mixed-pair slice.
