...
|---:|---:|---:|---:|---|---|---|---|---|---|---|
| 40 | 2.75 | 4.45 | 0.611 | early_strong | intersection_merge | motorcyclist_conflict, pedestrian_conflict, heavy_vehicle_conflict, road_surface_weather, intersection_merge | parked vehicle partially obstructing the sidewalk | intersection_merge_p01 | confirmed_mixed_pair | human_reviewed_2026-05-06_no_issue |
| 112 | 0.90 | 4.45 | 0.590 | early_marginal | intersection_merge | motorcyclist_conflict, pedestrian_conflict, heavy_vehicle_conflict, road_surface_weather, intersection_merge | parked vehicle partially obstructing the sidewalk | intersection_merge_p02 | confirmed_mixed_pair | human_reviewed_2026-05-06_no_issue |
| 0 | 0.85 | 4.45 | 0.613 | early_marginal | intersection_merge | motorcyclist_conflict, pedestrian_conflict, heavy_vehicle_conflict, visibility_night, intersection_merge | large truck merging into traffic. | intersection_merge_p03 | confirmed_mixed_pair | human_reviewed_2026-05-06_no_issue |
| 111 | 0.40 | 4.45 | 0.629 | early_marginal | intersection_merge | motorcyclist_conflict, pedestrian_conflict, heavy_vehicle_conflict, road_surface_weather, intersection_merge | parked vehicle partially obstructing the sidewalk | intersection_merge_p04 | confirmed_mixed_pair | human_reviewed_2026-05-06_no_issue |
...
| 1 | -1.00 | 4.45 | 0.409 | late_or_missed | intersection_merge | motorcyclist_conflict, pedestrian_conflict, heavy_vehicle_conflict, road_surface_weather, intersection_merge | parked vehicle partially obstructing the sidewalk | intersection_merge_p01 | confirmed_mixed_pair | human_reviewed_2026-05-06_no_issue |
...
| 33 | -1.00 | 4.45 | 0.279 | late_or_missed | intersection_merge | motorcyclist_conflict, pedestrian_conflict, heavy_vehicle_conflict, road_surface_weather, intersection_merge | parked vehicle partially obstructing the sidewalk | intersection_merge_p02 | confirmed_mixed_pair | human_reviewed_2026-05-06_no_issue |
| 34 | -1.00 | 4.45 | 0.329 | late_or_missed | intersection_merge | motorcyclist_conflict, pedestrian_conflict, heavy_vehicle_conflict, visibility_night, intersection_merge | large truck merging into traffic. | intersection_merge_p03 | confirmed_mixed_pair | human_reviewed_2026-05-06_no_issue |
...
| 71 | -1.00 | 4.45 | 0.452 | late_or_missed | intersection_merge | motorcyclist_conflict, pedestrian_conflict, heavy_vehicle_conflict, road_surface_weather, intersection_merge | parked vehicle partially obstructing the sidewalk | intersection_merge_p04 | confirmed_mixed_pair | human_reviewed_2026-05-06_no_issue |
