...
- [x] Cut a technical freeze candidate tarball (`freeze_arr_submission.sh`); final upload adoption remains pending human read-through approval.
...
- [x] Run one last sanity and first-25 PDF freshness check.
